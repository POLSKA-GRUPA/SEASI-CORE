# Proposal: sea-sic-core-v0 — Despacho Shell v0 (cliente cero el despacho) + despliegue en dos fases
...
El objetivo: **SEASI Despacho**, la app de escritorio del despacho, construida primero para el cliente cero con coste de infraestructura ≈ 0 €, y lista para convertirse en producto white-label multi-inquilino cuando se pague la fase comercial (firma Apple/Windows, notarización, CI multiplataforma).
...
5. **Despliegue en 2 fases** como requisitos de spec, no como después de pensar:
   - **Fase INTERNA (v0, el despacho)**: DMG ad-hoc + script de instalación, GitHub Releases privado con feed de actualizaciones firmado (clave pública embebida), cero telemetría, coste 0 €.
...
- **el cliente cero**: pasa de flujos CLI/pi a la app del despacho con HITL visual.
